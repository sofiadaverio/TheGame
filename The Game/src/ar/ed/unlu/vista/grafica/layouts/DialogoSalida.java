...
public class DialogoSalida extends JDialog {
    ...
    public DialogoSalida(Window parent) {
        ...
        lblTitulo.setFont(fuenteTexto != null ? fuenteTexto.deriveFont(22f) : new Font("Arial", Font.BOLD, 20));
        lblTitulo.setBounds(50, 40, 400, 80);
        panelFondo.add(lblTitulo);

        // BOTÓN 1: GUARDAR Y SALIR (Verde)
        BotonCristal btnGuardar = new BotonCristal("GUARDAR Y SALIR", "BOTON_VERDE.png");
        btnGuardar.setBounds(50, 140, 180, 45);
        ...
        btnSalir.setBounds(270, 140, 180, 45);
        ...
        btnCancelar.setBounds(175, 210, 150, 40);
