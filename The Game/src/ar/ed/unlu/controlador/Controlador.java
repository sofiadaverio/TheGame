...
public class Controlador implements IControladorRemoto {
    ...
    public void enviarMensajeChat(MensajesSala m, String emisor) { enviarChat(m, emisor); }
    public void enviarMensajeChat(MensajesPro m, String emisor) { enviarChat(m, emisor); }
    public void enviarMensajeChat(MensajesNormal m, String emisor) { enviarChat(m, emisor); }

    public void enviarChat(MensajesPro m, String emisor) { try { this.juego.transmisi0nMensaje(m, emisor); } catch (RemoteException e) { } }
    public void enviarChat(MensajesNormal m, String emisor) { try { this.juego.transmisi0nMensaje(m, emisor); } catch (RemoteException e) { } }
    public void enviarChat(MensajesSala m, String emisor) { try { this.juego.transmisi0nMensaje(m, emisor); } catch (RemoteException e) { } }
    ...
    public void agregarVista(String nombre, IVista vista) {
        ...
        try {
            ...
            if (mensajeLimpio.contains("RemoteException: ")) {
                mensajeLimpio = mensajeLimpio.substring(mensajeLimpio.indexOf("RemoteException: ") + 17);
            }
    ...
    public void guardarPartida() {
        try {
            ...
            this.mensajeFeedback = "Partida guardada con éxito.";
            actualizarVistas();
        } catch (RemoteException e) {
            this.mensajeFeedback = "Error al guardar: " + e.getMessage();
            try { actualizarVistas(); } catch (Exception ex) {}
        }
    }
